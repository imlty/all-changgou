...
public class FastDFSClient {
    ...
    //图片下载
    public static InputStream downFile(String groupName, String remoteFileName) { //group1 M00/00/00/wKjThF1aW9CAOUJGAAClQrJOYvs424.jpg
    ...
    public static void deleteFile(String groupName, String remoteFileName) { //group1 M00/00/00/wKjThF1aW9CAOUJGAAClQrJOYvs424.jpg
        try {
            //3.创建trackerclient对象
            TrackerClient trackerClient = new TrackerClient();
            //4.创建trackerserver 对象
    ...
    public static StorageServer getStorages(String groupName) { //group1
        try {
            TrackerClient trackerClient = new TrackerClient();
            //4.创建trackerserver 对象
            TrackerServer trackerServer = trackerClient.getConnection();
    ...
    public static FileInfo getFile(String groupName, String remoteFileName) { // group1  M00/00/00/wKjThF1aW9CAOUJGAAClQrJOYvs424.jpg
        try {
            TrackerClient trackerClient = new TrackerClient();
            //4.创建trackerserver 对象
            TrackerServer trackerServer = trackerClient.getConnection();
    ...
    //根据文件名和组名 获取组信息的数组信息
    public static ServerInfo[] getServerInfo(String groupName, String remoteFileName){ // group1  M00/00/00/wKjThF1aW9CAOUJGAAClQrJOYvs424.jpg
        try {
            //3.创建trackerclient对象
            TrackerClient trackerClient = new TrackerClient();
            //4.创建trackerserver 对象
